...
public class TestMultSeS  extends SimulateModel {
	...
	public static void main(String[] args) {
		...
		TestMultSeS sm = new TestMultSeS();

		String modelName ="IoTSmartApp";
		String sesfile = "IoTSmartApp.ses";
		String pesfile = "IoTSmartAppBase.pes";
