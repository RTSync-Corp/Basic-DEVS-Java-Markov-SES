...
public class ComWLatency extends AtomicModelImpl implements PhaseBased,
    StateVariableBased {
    ...
    // Input ports
    //ID:INP:0
    public final Port<Serializable> inLinkInput =
        addInputPort("inLinkInput", Serializable.class);
    ...
    // Output ports
    //ID:OUTP:0
    public final Port<Serializable> outLinkOutput =
        addOutputPort("outLinkOutput", Serializable.class);
    ...
    public ComWLatency(String name) {
        this(name, null);
    }

    public ComWLatency(String name, Simulator simulator) {
    ...
    public void initialize() {
        ...
        ctm.addTransitionInfoForExponential("Wait", new String[] {"Wait"}, new double[] {1.}); 
...
//        }
    ...
    public static void main(String[] args) {
        ComWLatency model = new ComWLatency();
    ...
    protected static File getModelsDirectory() {
        ...
        File dir;
        try {
            dirUri = ComWLatency.class.getResource(".").toURI();
            dir = new File(dirUri);
        } catch (URISyntaxException e) {
            e.printStackTrace();
            throw new RuntimeException(
                "Could not find Models directory. Invalid model URL: " +
                ComWLatency.class.getResource(".").toString());
        }
